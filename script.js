...
// -------------------------------
// Continuous LED ticker
// -------------------------------
// Duplicate the ticker items so the marquee loops seamlessly.
const tickerTrack = document.querySelector(".ticker-track");

if (tickerTrack && !tickerTrack.dataset.loopReady) {
    const originalTickerItems = Array.from(tickerTrack.children);

    if (originalTickerItems.length) {
        ...
        tickerTrack.dataset.loopReady = "true";
    }
}
